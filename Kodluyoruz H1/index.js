...
const loadUsers = () => {
  ...
  let loadgf = document.querySelector('#gf');
  loadgf.style.display = 'block';

  setTimeout(() => {
    loadgf.style.display = 'none';
...
const renderUsers = (users = []) => {
  ...
  <tr>
  <th scope="col">Id</th>
    <th scope="col" id="reverse">Sıra No</th>
    <th scope="col">Name</th>
    <th scope="col">Email</th>
    <th scope="col">Phone</th>
    <th scope="col">Website</th>
  ...
  document.querySelector("#reverse").addEventListener('click', reverseList);
